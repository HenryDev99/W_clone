...
import { NewDataDTO } from 'types/new/newDTO'
...
const NewLayout: React.FC = () => {
  ...
  const fetchDatas = async () => {
    const daily = await getNewDailyList()
    const weekly = await getNewWeeklyList()
    console.log(daily)
    return {
      daily: daily,
      weekly: weekly
  ...
  const { data: newDatas, isLoading } = useQuery<NewDataDTO, Error>(
    'getDatas',
    fetchDatas,
    {
        ...
        <section className="thumbnail-container">
          ...
          >
            ...
            >
              ...
              >
                <h4
                  style={{ padding: '20px', fontSize: '28px', color: 'white' }}
                >
                  TODAY
                  <br />
                  UPDATED
